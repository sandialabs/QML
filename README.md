...
> 5. <a id="umap"></a> Leland McInnes, John Healy, James Melville. *Umap: Uniform manifold approximation and projection for dimension reduction*, [arXiv:1802.03426](https://arxiv.org/abs/1802.03426) (2018).
> 6. <a id="tsne"></a> L.J.P. van der Maaten and G.E. Hinton. *Visualizing High-Dimensional Data Using t-SNE*, JMLR (2008).
> 7. <a id="lap-eigmaps"></a> Mikhail Belkin, Partha Niyogi. *Laplacian eigenmaps for dimensionality reduction and data representation*. Neural Computation (2003).
> 8. <a id="diffmaps"></a> 
> 9. <a id="eigen-redundancy"></a>